...
interface PalindromeExchangeInterface extends ethers.utils.Interface {
  functions: {
...
export class PalindromeExchange extends BaseContract {
  ...
  interface: PalindromeExchangeInterface;
