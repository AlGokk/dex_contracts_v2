...
interface PalindromeRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class PalindromeRouter extends BaseContract {
  ...
  interface: PalindromeRouterInterface;
