...
interface PalindromeFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class PalindromeFactory extends BaseContract {
  ...
  interface: PalindromeFactoryInterface;
