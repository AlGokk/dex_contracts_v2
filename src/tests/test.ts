...
import DEX from '../artifacts/src/contracts/PalindromeExchange.sol/PalindromeExchange.json';
...
before(async () => {
  ...
  Factory = await ethers.getContractFactory('PalindromeFactory');
  factory = await Factory.deploy();
  await factory.deployed();

  Router = await ethers.getContractFactory('PalindromeRouter');
